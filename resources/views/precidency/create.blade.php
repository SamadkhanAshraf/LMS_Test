                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <form action="{{ route('precidency.store') }}" method="post">
                                                    @method('post')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">precidency name</label>
                                                            <input type="text" class="form-control {{ $errors->has('name')?'is-invalid':'' }}" placeholder="precidency Name" name="name">
                                                            <small class="text-danger">{{ $errors->first('name') }}</small>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">precidency description</label>
                                                            <textarea class="form-control {{ $errors->has('description')?'is-invalid':'' }}" placeholder="precidency Description " name="description"></textarea>
                                                            <small class="text-danger">{{ $errors->first('description'); }}</small>
                                                        </div>
                                                    </div>
                                                <button type="submit" class="btn  btn-primary">Add precidency</button>
                                                </form>
                                        </div>
                                        <div class="col-md-6">
