                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <form action="{{ route('precidency.update',$precidency->id) }}" method="post">
                                                    @method('put')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">precidency name</label>
                                                            <input type="text" class="form-control {{ $errors->has('name')?'is-invalid':'' }}" placeholder="precidency Name" name="name" value="{{$precidency->name}}">
                                                            <small class="text-danger">{{ $errors->first('name') }}</small>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">Category description</label>
                                                            <textarea class="form-control {{ $errors->has('description')?'is-invalid':'' }}" placeholder="precidency Description " name="description">{{$precidency->description}}</textarea>
