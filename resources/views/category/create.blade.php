                                                ...
                                                <form action="{{ route('category.store') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control {{ $errors->has('name')?'is-invalid':'' }}" placeholder="category Name" name="name">
                                                            <small class="text-danger">{{ $errors->first('name') }}</small>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">Category description</label>
                                                            <textarea class="form-control {{ $errors->has('description')?'is-invalid':'' }}" placeholder="Category Description " name="description"></textarea>
