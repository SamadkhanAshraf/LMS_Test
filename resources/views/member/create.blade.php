                                                ...
                                                <form action="{{ route('member.store') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control {{ $errors->has('name')?'is-invalid':'' }}" placeholder="Enter memeber name" name="name">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                                ...
                                                                <select class="form-select {{ $errors->has('department')?'is-invalid':'' }}" id="department" name="department">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control {{ $errors->has('fname')?'is-invalid':'' }}" placeholder="Enter member father name" name="fname">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                                ...
                                                                <select class="form-select {{ $errors->has('precidency')?'is-invalid':'' }}" id="precidency" name="precidency">
                                                    ...
                                                    <div class="form-group col-md">
                                                            ...
                                                            <input type="textarea" class="form-control {{ $errors->has('address')?'is-invalid':'' }} height:20%"  placeholder="Enter member address" name="address">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="phone" class="form-control {{ $errors->has('phone')?'is-invalid':'' }}" id="inputAddress" placeholder="Enter member phone" name="phone">
                                                            <small class="text-danger">{{ $errors->first('phone') }}</small>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label class="form-label" for="email">Email</label>
                                                            <input type="email" class="form-control {{ $errors->has('email')? 'is-invalid': ''}}" id="inputAddress" placeholder="Enter member email" name="email">
