                                                ...
                                                <form action="{{ route('book.update',$book) }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control {{ $errors->has('Title')?'is-invalid':'' }}" placeholder="Book Name" name="title" value="{{$book->title}}">
                                                            <small class="text-danger">{{ $errors->first('title') }}</small>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">Author</label>
                                                            <input type="text" class="form-control {{ $errors->has('Author')?'is-invalid':'' }}" placeholder="Author Name" name="author" value="{{$book->author}}">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="textarea" class="form-control {{ $errors->has('Description')?'is-invalid':'' }}" placeholder="Book Details" name="description" value="{{$book->description}}">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control {{ $errors->has('Author')?'is-invalid':'' }}" id="inputAddress" placeholder="Book Section" name="section" value="{{$book->section}}">
                                                            <small class="text-danger">{{ $errors->first('section') }}</small>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label class="form-label" for="quantity">Book Quantity</label>
                                                            <input type="number" class="form-control {{ $errors->has('Quantity')? 'is-invalid': ''}}" id="inputAddress" placeholder="Book Quantity" name="quantity" value="{{$book->quantity}}">
